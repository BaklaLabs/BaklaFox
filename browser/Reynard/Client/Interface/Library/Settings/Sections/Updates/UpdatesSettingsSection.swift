...
final class UpdatesSettingsSection {
    ...
    private func beginUpdate(from viewController: UIViewController) {
        ...
        if installedThroughTrollStore {
            ...
            downloadUpdate(
                from: packageURL,
                fileName: "BaklaFox.ipa",
                expectedSize: expectedSize,
                message: "When the download finishes, choose the app that you used to sideload BaklaFox in the share sheet to install the update.",
