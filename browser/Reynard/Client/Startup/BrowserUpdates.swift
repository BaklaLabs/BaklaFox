...
final class BrowserUpdates: NSObject {
    ...
    private static let sourceURL = "https://github.com/BaklaLabs/BaklaFox/releases/download/0.0.1-a1/source.json"
    private override init() {
        super.init()
        
        guard let docs = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first else { return }
        let sideloadIPA = docs.appendingPathComponent("BaklaFox.ipa")
